...
export default function MeetTheTeam() {
  ...
  const renderCard = (member: TeamMember) => (
    <motion.div
      ...
      className="relative flex items-center gap-4 bg-[#111111]/30 border border-white/10 hover:border-[#00ef4f]/40 hover:shadow-[0_0_20px_rgba(0,239,79,0.06)] rounded-xl p-4 backdrop-blur-sm transition-all duration-300 w-full max-w-[290px] sm:max-w-[300px] h-[130px] overflow-hidden group"
    >
      ...
      {/* Cyberpunk headshot / avatar placeholder */}
      <div className="w-20 h-20 sm:w-22 sm:h-22 bg-black/40 border border-white/10 group-hover:border-[#00ef4f]/30 rounded-lg shrink-0 overflow-hidden relative flex items-center justify-center transition-colors">
        ...
        <svg className="w-10 h-10 text-white/10 group-hover:text-[#00ef4f]/30 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
        </svg>

        {/* Small tech target crosshairs */}
        <div className="absolute top-1 left-1 w-1 h-1 border-t border-l border-white/30 group-hover:border-[#00ef4f]/40" />
        <div className="absolute top-1 right-1 w-1 h-1 border-t border-r border-white/30 group-hover:border-[#00ef4f]/40" />
        <div className="absolute bottom-1 left-1 w-1 h-1 border-b border-l border-white/30 group-hover:border-[#00ef4f]/40" />
        <div className="absolute bottom-1 right-1 w-1 h-1 border-b border-r border-white/30 group-hover:border-[#00ef4f]/40" />
      </div>

      {/* Details layout */}
      <div className="flex flex-col justify-center text-left min-w-0 flex-1">
        <span className="text-[#00ef4f] text-[9px] font-mono tracking-wider font-semibold uppercase truncate block mb-0.5">
          {member.role}
        </span>
        <h4 className="text-sm font-extrabold text-white tracking-wide uppercase font-sans truncate mb-2 group-hover:text-[#00ef4f]/90 transition-colors">
          {member.name}
        </h4>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          {member.phone && (
            <div className="flex items-center gap-1 text-[8.5px] font-mono text-white/30 group-hover:text-[#00ef4f]/40 transition-colors">
      ...
      <div className="max-w-6xl w-full relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-16">
          ...
          >
            ...
            <motion.div 
              variants={itemVariants} 
              className="border border-[#00ef4f]/30 bg-[#00ef4f]/5 rounded px-3 py-1.5 text-[#00ef4f] font-mono text-[10px] md:text-xs uppercase tracking-widest inline-block w-fit mt-1"
            >
          ...
          <div className="relative w-full h-64 flex items-center justify-center overflow-hidden border border-white/5 bg-[#111111]/10 rounded-2xl">
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      animation: `ripple-wave 2.5s ease-in-out infinite`,
            ...
            <div className="relative z-10 flex items-center justify-center">
              <svg
                ...
                className="filter drop-shadow-[0_0_25px_rgba(0,239,79,0.7)]"
              >
                <path
